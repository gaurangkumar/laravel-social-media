...
<head>
    ...
    <!--
	<link href="{{ asset('comming-soon/common-css/bootstrap.css') }}" rel="stylesheet">
	<link href="{{ asset('comming-soon/common-css/ionicons.css') }}" rel="stylesheet">
    -->
				...
				<div class="display-table center-text" style="background: linear-gradient(red,blue);opacity: 0.7">
					<div class="display-table-cell" style="opacity: 1.0 !important">
						...
						<div id="rounded-countdown" style="opacity: 1.0 !important">
							<div class="countdown" data-remaining-sec="{{ strtotime("1 December 2020") - time() }}" style="opacity: 1.0 !important"></div>
						</div>
