                    ...
                    <div class="header">
                        <div class="header-top">
                            <div class="logo ml-2 mt-3">
                                <a href="index-2.html">
                                    <img src="{{ asset('/template/assets/img/logo.png') }}" class="header_image img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <ul class="nav nav-tabs chat-tabs mt-4">
                            <li class="nav-item">
                                <a class="nav-link  active" href="index-2.html">Chat</a>
                            </li>
                            ...
                            <li class="user-list-item">
                                <div>
                                    <div class="avatar avatar-away">
                                        <img src="{{ asset('/template/assets/img/avatar-7.jpg') }}" class="rounded-circle" alt="image">
                                    </div>
                                </div>
                                <div class="users-list-body">
                                    <div>
                            ...
                            <li class="user-list-item">
                                <div>
                                    <div class="avatar avatar-offline">
                                        <img src="{{ asset('/template/assets/img/avatar-1.jpg') }}" class="rounded-circle" alt="image">
                                    </div>
                                </div>
                                <div class="users-list-body">
                                    <div>
