		...
		<div class="col s12">
          <div class="container">
            ...
            <div class="col s12" id="account">
              ...
              <a class="mr-2" href="#">
                <img src="{{ empty($group->profile) ? asset('storage/index.jpg') : asset(\Storage::url($group->profile)) }}" alt="" class="z-depth-4 circle" height="64" width="64">
              </a>
              <div class="media-body">
                <h5 class="media-heading mt-0">{{ ucwords($group->name) }}</h5>
                <div class="user-edit-btns display-flex">
                  <form action="{{ route('admin.group.profile.update', $group->id) }}"
                        method="post"
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <input id="name" name="name" type="text" class="validate" value="{{ $group->name }}" data-error=".errorTxt1">
