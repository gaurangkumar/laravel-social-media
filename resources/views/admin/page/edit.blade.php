		...
		<div class="col s12">
          <div class="container">
            ...
            <div class="form-group">
              ...
              <div class="card-alert card gradient-45deg-green-teal">
                <div class="card-content white-text">
                  <p>
                    <i class="material-icons">check</i> SUCCESS : {{ session('status') }}
                  </p>
                </div>
            ...
            <div class="col s12" id="account">
              ...
              <a class="mr-2" href="#">
                <img src="{{ empty($page->profile) ? asset('storage/index.jpg') : asset(\Storage::url($page->profile)) }}" alt="" class="z-depth-4 circle" height="64" width="64">
              </a>
              <div class="media-body">
                ...
                <div class="user-edit-btns display-flex">
                  ...
                  @if(!empty($page->profile))
					<form action="{{ route('admin.page.profile.delete', $page->id) }}" method="post">
                  @method('delete')
                  @csrf
              ...
              <form id="accountForm" method="post" action="{{ route('admin.page.update', $page->id) }}">
              @method('put')
              @csrf
              <div class="row">
                ...
                <div class="row">
                  ...
                  <input id="name" name="name" type="text" class="validate" value="{{ $page->name }}" data-error=".errorTxt1">
                  <label for="name">Name</label>
                  <small class="errorTxt1"></small>
                  </div>
                  <div class="col s12 input-field">
                  <input id="uname" name="uname" type="text" class="validate" value="{{ $page->uname }}"
                ...
                <div class="row">
                  <div class="col s12 input-field">
                  <input id="description" name="description" type="text" class="validate" value="{{ $page->description }}" data-error=".errorTxt2">
