          ...
          <table id="users-list-datatable" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('admin.page.edit', $page->id) }}"><i class="material-icons">edit</i></a></td>
                <td><a href="{{ route('admin.page.show', $page->id) }}"><i class="material-icons">remove_red_eye</i></a></td>
